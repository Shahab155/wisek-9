...
Highly trained K9 units for maximum threat detection          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="animate-slide-right">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
             Our canine security services deploy professionally trained dogs and handlers to detect threats, control high-risk environments, and provide an unmatched security presence.
            </p>
