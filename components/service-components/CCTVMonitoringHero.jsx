...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaVideo } from 'react-icons/fa';

export default function CCTVMonitoringHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="CCTV Monitoring Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaVideo className="text-[#ED1D2B] mr-2" /> Licensed Operators
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            Licensed CCTV operators providing real-time monitoring and detailed incident reporting
          </p>
