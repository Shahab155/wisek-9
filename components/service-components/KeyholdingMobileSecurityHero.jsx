...
export default function KeyholdingMobileSecurityHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Keyholding & Mobile Security Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaCar className="text-[#ED1D2B] mr-2" /> Branded Response Vehicles
            </div>
          </div>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
            Keyholding & Mobile Security
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            24/7 keyholding and mobile security services with alarm response capabilities
          </p>
