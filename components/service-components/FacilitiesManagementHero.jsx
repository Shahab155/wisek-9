...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaBuilding } from 'react-icons/fa';

export default function FacilitiesManagementHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Facilities Management Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaBuilding className="text-[#ED1D2B] mr-2" /> Fully Insured
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            Comprehensive cleaning services with fully insured and vetted staff
          </p>
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              ...
              From pre & end of tenancy cleaning to specialized services like upholstery, carpet, and oven cleaning, 
              we ensure your premises remain spotless and professional.
            </p>
          </div>
