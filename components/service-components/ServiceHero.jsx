...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaStar } from 'react-icons/fa';

export default function ServiceHero({ title = "Security Services", subtitle = "Professional Protection Solutions" }) {
  return (
    <section 
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaStar className="text-[#ED1D2B] mr-2" /> Trusted Since 2015
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Professional security solutions tailored to meet your specific needs. 
              Our experienced team provides reliable, discreet, and effective protection services.
            </p>
          </div>
