  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-[#ED1D2B]/80 via-black/70 to-[#ED1D2B]/80"></div>
      </div>
      ...
      {/* <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-20">
        <nav className="flex items-center space-x-2 text-white text-sm" aria-label="Breadcrumb">
          ...
          <span className="text-[#ED1D2B] font-semibold">Contact</span>
        </nav>
      </div> */}
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-6">
            <div className="flex items-center text-white/90 text-sm">
              <FaPhone className="text-[#ED1D2B] mr-2" /> 0330 043 4152
            </div>
            <div className="flex items-center text-white/90 text-sm">
              <FaEnvelope className="text-[#ED1D2B] mr-2" /> info@wisek9.co.uk
            </div>
            <div className="flex items-center text-white/90 text-sm">
              <FaMapMarkerAlt className="text-[#ED1D2B] mr-2" /> UK Wide Coverage
            </div>
          </div>
          ...
          >
            Contact <span className="text-[#ED1D2B]">Wise-K9</span>
          </h1>
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Have questions about our security services? Reach out to our team for a free consultation. 
              We're available 24/7 to discuss your security needs.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            ...
            <Link
              href="/contact"
              className="px-8 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold rounded-full border border-white/30 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
            >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex flex-col items-center">
        <span className="text-white/70 text-xs mb-2">Learn More</span>
