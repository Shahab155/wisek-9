...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaUserShield } from 'react-icons/fa';

export default function MannedGuardingHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Manned Guarding Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaUserShield className="text-[#ED1D2B] mr-2" /> Professional Guards
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            WANT TO PROTECT YOUR BUSINESS? WE PROVIDE SIA-LICENSED SECURITY GUARDS NATIONALLY.
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              WE PROVIDE RELIABLE MANNED GUARDING IN SURREY. Professional manned guarding focused on visibility, 
              prevention, and rapid response to ensure your business remains secure and protected.
            </p>
          </div>
