...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaPaw, FaCheckCircle } from 'react-icons/fa';

export default function CanineSecurityHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Canine Security Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            OUTSTANDING CANINE SECURITY
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Providing canine services that are more effective than traditional security methods. 
              Professionals who meet the highest standards. OUR CANINE SECURITY SERVICES ARE LEADING THE WAY.
            </p>
          </div>
