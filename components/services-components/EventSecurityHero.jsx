...
export default function EventSecurityHero() {
  return (
    <section
      ...
      aria-label="Event Security Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaUsers className="text-[#ED1D2B] mr-2" /> Event Specialists
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            BEST OF A KIND EVENT SECURITY
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Are you planning a gathering or party and looking for Event security? Do not worry, 
              Wise-K9 assure to keep every attendee safe so you can have fun with your guests and friends. 
              Our professional team assesses risks and monitors suspicious activities.
            </p>
          </div>
