...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaHardHat } from 'react-icons/fa';

export default function ConstructionSecurityHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Construction Security Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaHardHat className="text-[#ED1D2B] mr-2" /> Trained Guards
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            WISE-K9 OFFERS ALL-IN-ONE CONSTRUCTION SECURITY
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Comprehensive construction site security solutions with trained guards, 
              equipment protection, and constant vigilance to ensure your project continues without interruption.
            </p>
          </div>
