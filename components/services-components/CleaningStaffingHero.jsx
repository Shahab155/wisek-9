...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaBroom } from 'react-icons/fa';

export default function CleaningStaffingHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Cleaning & Staffing Services Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaBroom className="text-[#ED1D2B] mr-2" /> Professional Cleaners
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            WISE-K9 CLEANING SERVICES
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              We are a leading distributor of office cleaners who are also serving commercial and domestic properties. 
              Delivering fully managed, efficient and flexible cleaning services. We operate nationwide.
            </p>
          </div>

          {/* Tagline */}
          {/* <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg max-w-2xl mx-auto">
            <p className="text-white font-semibold">
              WE PARTNER WITH CLIENTS FROM DIFFERENT BUSINESSES, LOOKING TO CREATE THE BEST LEGACY.
            </p>
          </div> */}
