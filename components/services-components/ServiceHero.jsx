...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaConciergeBell } from 'react-icons/fa';
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaConciergeBell className="text-[#ED1D2B] mr-2" /> Professional Staff
            </div>
          </div>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
            OUR <span className="text-[#ED1D2B]">SERVICES</span>
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            COMPREHENSIVE SECURITY SOLUTIONS FOR YOUR BUSINESS AND PROPERTY
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Explore our range of professional security services designed to protect your business, 
              property, and people with SIA-licensed professionals and cutting-edge technology.
            </p>
          </div>
