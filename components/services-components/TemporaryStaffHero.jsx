...
import { FaShieldAlt, FaMapMarkerAlt, FaClock, FaUserTie } from 'react-icons/fa';

export default function TemporaryStaffHero() {
  return (
    <section
      className="relative w-full h-[70vh] flex items-center justify-center overflow-hidden"
      aria-label="Temporary Staff Support Services Hero Section"
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4">
        <div className="space-y-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-4">
            ...
            <div className="flex items-center text-white/90 text-sm">
              <FaUserTie className="text-[#ED1D2B] mr-2" /> Professional Staff
            </div>
          </div>
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mx-auto leading-relaxed">
            TEMPORARY CONSTRUCTION SITE SECURITY FOR TODAY AND TOMORROW
          </p>

          {/* Description */}
          <div className="max-w-4xl mx-auto">
            <p className="text-white/90 text-base md:text-lg">
              Helping fill gaps by providing short to medium-term contracts. 
              Supplying temporary staff for door and in-store services, 
              integrating support service and help desk officers to manage event security.
            </p>
          </div>
