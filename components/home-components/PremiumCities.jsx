      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center mb-6">
            ...
            <span className="mx-4 text-[#ED1D2B] text-sm font-semibold tracking-widest uppercase">
              Coverage
            </span>
            <div className="w-16 h-0.5 bg-[#ED1D2B]"></div>
          </div>
          ...
          >
            Professional security services across the UK's major metropolitan
            areas with local expertise and rapid response capabilities.
          </motion.p>
        </motion.div>
          ...
          <div className="bg-gradient-to-r from-[#ED1D2B] to-[#c01522] rounded-3xl p-10 text-white shadow-xl hover:shadow-2xl transition-all duration-500 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-6 text-white/90">
                We cover 87% of the UK. Contact us to discuss tailored security
                solutions.
              </p>
              <Link
                href="/contact"
